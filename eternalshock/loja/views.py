...
class CriarProdutoView(StaffRequiredMixin, CreateView):
    """Cria um novo produto"""
    model = Produto
    fields = ['nome', 'descricao', 'categoria', 'preco', 'estoque', 'imagem', 'ativo']
    template_name = 'loja/admin_produto.html'
    success_url = reverse_lazy('loja:index')
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Criar Produto - Loja'
        context['editar'] = False
        return context


class EditarProdutoView(StaffRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy('loja:detalhes', kwargs={'produto_id': self.object.id})
...
class DeletarProdutoView(StaffRequiredMixin, DeleteView):
    """Deleta um produto"""
    model = Produto
    template_name = 'loja/deletar_produto.html'
    pk_url_kwarg = 'produto_id'
    success_url = reverse_lazy('loja:index')
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = f'Deletar - {self.object.nome}'
        return context
